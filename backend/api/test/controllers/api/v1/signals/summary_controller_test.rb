...
class Api::V1::Signals::SummaryControllerTest < ApiTestCase
  ...
  test "success" do
    get_json api_v1_signals_me_summary_path, headers: @headers
  ...
  test "no health summary" do
    # bob has no health_summary
    get_json api_v1_signals_me_summary_path, headers: auth_headers(users(:bob))
  ...
  test "unauthorized" do
    get_json api_v1_signals_me_summary_path
