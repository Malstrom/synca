...
class Api::V1::Signals::SummaryControllerTest < ActionDispatch::IntegrationTest
  ...
  test "GET /api/v1/signals/me/summary returns 200 with correct payload" do
    ...
    assert_equal "Early bird", summary["chronotype_label"]
    assert_equal "high",       summary["routine_stability_tier"]
    assert_equal "medium",     summary["activity_tier"]
    assert_equal 450,          summary["avg_sleep_duration_minutes"]
