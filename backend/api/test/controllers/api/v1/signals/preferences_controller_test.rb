...
class Api::V1::Signals::PreferencesControllerTest < ApiTestCase
  ...
  test 'POST /api/v1/signals/preferences returns 200 with preferences payload' do
    ...
    assert_equal 'morning', payload[:self_chronotype]
  end
  ...
  test 'POST /api/v1/signals/preferences persists updated values in db' do
    post_json '/api/v1/signals/preferences',
              params: { preferences: @valid_params[:preferences].merge(sleep_together_importance: 5) },
              headers: @headers

    assert_response :ok
    assert_equal 5, @user.preference_profile.reload.sleep_together_importance
  end

  test 'POST /api/v1/signals/preferences with partial update leaves other fields unchanged' do
    initial_attrs = @valid_params[:preferences].merge(sleep_together_importance: 2)
    post_json '/api/v1/signals/preferences',
              params: { preferences: initial_attrs },
              headers: @headers
    ...
    assert_response :ok
    profile = @user.preference_profile.reload
  ...
  test 'POST /api/v1/signals/preferences with invalid movement_preference returns 422' do
    post_json '/api/v1/signals/preferences',
              params: { preferences: @valid_params[:preferences].merge(movement_preference: 'invalid') },
              headers: @headers
  ...
  test 'POST /api/v1/signals/preferences with invalid rhythm_importance returns 422' do
    post_json '/api/v1/signals/preferences',
              params: { preferences: @valid_params[:preferences].merge(rhythm_importance: 0) },
              headers: @headers
  ...
  test 'POST /api/v1/signals/preferences with invalid self_chronotype returns 422' do
    post_json '/api/v1/signals/preferences',
              params: { preferences: @valid_params[:preferences].merge(self_chronotype: 'invalid') },
              headers: @headers
