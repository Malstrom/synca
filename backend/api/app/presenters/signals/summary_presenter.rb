      ...
      class SummaryPresenter
        ...
        def self_report_alignment
          ...
          if preference_profile.self_chronotype == "depends"
            ...
            { aligned: aligned, note: alignment_note(aligned) } unless aligned
          end
        end
        ...
        def alignment_note(aligned)
          "You declared #{preference_profile.self_chronotype} but your data shows #{health_summary.chronotype}." unless aligned
        end
      end
    end
  end
