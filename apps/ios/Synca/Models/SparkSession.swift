...
struct SparkSession: Codable, Equatable, Identifiable {
    let id: Int
...
/// `GET /sparks` row — needed, not yet implemented server-side. Deliberately not
/// `SparkSession`: `SparkSerializer` has no `compatibility_score`, which the
/// Dashboard "YOUR SPARKS" list needs. See docs/api/openapi.yaml.
